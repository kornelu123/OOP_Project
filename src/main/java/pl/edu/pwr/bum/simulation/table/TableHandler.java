...
public class TableHandler {
    public static void printStatsTable(RandomEvent randomEvent){
        Table table = new TableBuilder()
            .tableBorder(AsciiBorders.BOLD)  /* set a BOLD border for table itself */
            .cell(randomEvent.description).maximumWidth(50)       /* add a cell with string content, (by default first row has been added) */
